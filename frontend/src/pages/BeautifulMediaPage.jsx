...
import {
    ...
    Eye, Share2, Clock, ChevronRight, Grid, List, TrendingUp
} from 'lucide-react';
...
const BeautifulMediaPage = () => {
    ...
    // Get featured items (most recent or most viewed)
    const featuredItems = useMemo(() => {
        return processedItems
            .filter(item => item.featured || (item.views && item.views > 100))
            .slice(0, 2);
    }, [processedItems]);
    ...
    return (
        <div className="py-20 bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto px-4">
                ...
                {/* Trending Section (if items exist) */}
                    ...
                    <div className="mb-12">
                        ...
                        <div className="flex gap-4 overflow-x-auto pb-4">
                            {trendingItems.map((item) => (
                                <div key={item.id || item._id} className="min-w-[200px] bg-white rounded-lg shadow-md p-4">
                                    ...
                                    <>
                                        ...
                                        <div className="p-4 flex flex-col flex-1">
                                            ...
                                            <Link
                                                ...
                                                className="w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-medium transition-colors text-sm text-center"
                                            >
